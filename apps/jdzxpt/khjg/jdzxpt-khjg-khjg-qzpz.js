...
export const name = "jdzxpt-khjg-khjg-qzpz";
require("./jdzxpt-khjg-khjg-qzpz.less");
require('/apps/common/common-rate-input');

let zhkp_qzpz_vm;

avalon.component(name, {
    template: __inline("./jdzxpt-khjg-khjg-qzpz.html"),
    defaults: {
        arrTabs: [{
            name: '部门权重配置'
        }],
        ...
        onInit(e) {
            ...
            $(".common-layout").addClass('min-set-layout');
            $(".jdzx-qzpz-wrap").addClass('min-width-class-khqktj-qzpz');
        ...
        onReady() {
            ...
            $(window).bind('beforeunload', function (event) { //ie
                $(window).unbind('beforeunload'); //在不需要时解除绑定   
                if (global.location.hash.indexOf("jdzxpt-khjg-khjg") > -1)
                    avalon.history.setHash("/jdzxpt-khjg-khjg");
            });
            ...
            $('.tree-level-nav').addClass('hide-tree-level-nav-from-qzpz');
        },
        onDispose() {
            $('.tree-level-nav').removeClass('hide-tree-level-nav-from-qzpz');
            $(".jdzx-qzpz-wrap").removeClass('min-width-class-khqktj-qzpz');
            $(".common-layout").removeClass('min-set-layout');
        },
        windowResize() {
