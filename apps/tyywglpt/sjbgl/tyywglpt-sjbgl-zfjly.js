...
export const name = 'tyywglpt-sjbgl-zfjly';
...
let sjbgl = avalon.component(name, {
    template: __inline('./tyywglpt-sjbgl-zfjly.html'),
    defaults: {
        dataStr: "",
        dataJson: {},
        type: null,
        ...
        fetchManuModelOptions() {
            ...
            let url = '/gmvcs/uom/device/gb28181/v1/device/manufacturer?manufacturer=';
        ...
        fetchManuToModel() {
            ...
            let url = `/gmvcs/uom/device/gb28181/v1/device/model?manufacturer=${manufacturer}&allType=`;  // allType 传 false
            ...
            sbzygl.ajax(url).then((result) => {
                ...
                let workstationCode = result.data;
                // 设备型号
...
const dialogUpdateInfoVm = avalon.define({
    ...
    fetchModelOptions() {
        ...
        let url = `/gmvcs/uom/device/gb28181/v1/device/model?manufacturer=${csid}&allType=`; // allType 传 false
        sbzygl.ajax(url).then(result => {
            if (result.code != 0) {
                sbzygl.showTips('error', result.msg);
                this.modelOptions.clear();
