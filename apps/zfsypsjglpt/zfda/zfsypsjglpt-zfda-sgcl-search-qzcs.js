...
avalon.component('ms-sgcl-search-qzcs', {
    ...
    defaults: {
                ...
                avalon.each(func_list, function (k, v) {
                    switch (v) {
                        case "AUDIO_FUNCTION_ZFDA_JTWF_QZCS_SEARCH":
                            ...
                            break;
                        case "AUDIO_FUNCTION_ZFDA_JTWF_QZCS_EXPORT":
                            vm.authority.EXPORT = true;
                            break; 
                    }
                });
        ...
        exportBtn() {
            ...
            let url = `//${window.location.host}${apiUrl}/gmvcs/audio/force/export?orgCode=${orgCode}&orgPath=${search_condition.orgPath}&includeChild=${search_condition.includeChild}&wfStartTime=${search_condition.wfStartTime}&wfEndTime=${search_condition.wfEndTime}&glmt=${search_condition.glmt}&userCode=${search_condition.userCode}&dsr=${search_condition.dsr}&jszh=${search_condition.jszh}&wfdz=${search_condition.wfdz}&pzbh=${search_condition.pzbh}&hphm=${search_condition.hphm}`;
