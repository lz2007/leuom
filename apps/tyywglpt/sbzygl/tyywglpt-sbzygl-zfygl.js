 ...
 * @Last Modified time: 2019-08-07 13:59:19
 */
/*
 * @Author: mikey.liangzhu 
    ...
    defaults: {
        ...
        handleTreeChange(e, selectedKeys) {
            ...
            if(this.title_index != null){
                ...
                // console.log(html_orgname);
                // console.log(this.title_index);
                // console.log(e.node.title,$(html_orgname[this.title_index]).attr("title"));
        ...
        extraExpandHandle(treeId, treeNode, selectedKey) {
            ...
            let data_zfycgslgl = storage.getItem('tyywglpt-sbzygl-zfygl-cgsl');
            let data_zfycgslgl_json = data_zfycgslgl ? JSON.parse(data_zfycgslgl) : null;
            // console.log(data_zfycgslgl_json);
            let o_this = this;
        ...
        query() {
            if (enableQuery) {
                this.current = 1;
                this.fetchList();
                let data_zfycgslgl_json = storage.getItem('tyywglpt-sbzygl-zfygl-cgsl') ? JSON.parse(storage.getItem('tyywglpt-sbzygl-zfygl-cgsl')) : null;
                ...
                if (data_zfycgslgl_json != null && data_zfygl_json != null) {
                    // console.log(data_zfycgslgl_json,data_zfygl_json);
                    if(data_zfycgslgl_json.orgName) {
                        // console.log(data_zfycgslgl_json.orgName,data_zfygl_json.orgName);
                        if(data_zfycgslgl_json.orgName != data_zfygl_json.orgName){
                            // console.log(11111111111);
                            let data_str3 = {
                                "page": data_zfycgslgl_json.page,
                            }
                            storage.setItem('tyywglpt-sbzygl-zfygl-cgsl', JSON.stringify(data_str3), 0.5);
                        }
                    }
                }
                enableQuery = false;
...
const dialogRegisterVm = avalon.define({
    ...
    getSearchSelected(label, value, owner) {
        ...
        if (owner === "manufacturer") {
            ...
            console.log('getSearchSelected' + value);
