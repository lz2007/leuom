...
export const name = 'zfsypsjglpt-jdkp-jqkp-ykp_gongan';
...
(function () {
    function Tools() {
        ...
        this.get_jycx_info = function (param) {
            ajax({
                url: '/gmvcs/audio/policeSituation/searchById/' + window.kpcczl_jqkp,
                ...
                if (ret.code == 0) {
                    ...
                    //获取关联媒体信息
                    ret.data.files = ret.data.handelerBaseFiles ? ret.data.handelerBaseFiles : [];
                    ...
                    kp_hccl.mtdata = ret.data.handelerBaseFiles; //接处警字段后台字段更改了
                    ...
                    ({
                        ...
                        jqbh: infos_of_jycx.jqbh,
                        bjsj: infos_of_jycx.bjsj,
                        sfdd: infos_of_jycx.sfdd,
                        bjrxm: infos_of_jycx.bjrxm,
                        bjrdh: infos_of_jycx.bjrdh,
                        bjnr: infos_of_jycx.bjnr,
                        ddxcsj: infos_of_jycx.ddxcsj,
                        zbmjxm: infos_of_jycx.zbmjxm,
                        zbmj: infos_of_jycx.zbmj,
                        xbmjxm: infos_of_jycx.xbmjxm,
                        xbmj: infos_of_jycx.xbmj,
                        cjdwmc: infos_of_jycx.cjdwmc,
                        sfsj: infos_of_jycx.sfsj,
                        cjsj: infos_of_jycx.cjsj,
                        jlly: infos_of_jycx.jlly,
                        jqlbmc: infos_of_jycx.jqlbmc,
                        relationCase: infos_of_jycx.relationCase,
                        mjyj: infos_of_jycx.mjyj,
                    } = ret.data);
                    infos_of_jycx.ddxcsj = Number(infos_of_jycx.ddxcsj && infos_of_jycx.ddxcsj.join(''));
                    infos_of_jycx.cjsj = Number(infos_of_jycx.cjsj && infos_of_jycx.cjsj.join(''));
                    infos_of_jycx.jlly = (infos_of_jycx.jlly || []).join(',') == '01' ? '后台系统同步' : '管理系统人工录入';
                    infos_of_jycx.relationCase = infos_of_jycx.relationCase == true ? '是' : '否';
                    // infos_of_jycx.type = Gm_tool.changeWfType(ret.data.type);
                    kp_hccl.infomation_type = '警情信息';
                    kp_hccl.checkLooking = (ret.data.jqmc || '-') + '(' + (ret.data.jqbh || '-') + ')';
        ...
        this.get_eva_info = function () {
            ajax({
                url: '/gmvcs/audio/policeSituation/eva/info/' + window.kpcczl_jqkp,
        ...
        this.set_review_info = function (params) {
                ajax({
                    url: '/gmvcs/audio/policeSituation/review',
            ...
            this.get_review_info = function () {
                ajax({
                    url: '/gmvcs/audio/policeSituation/review/info/' + window.kpcczl_jqkp,
...
avalon.component(name, {
    template: __inline('./zfsypsjglpt-jdkp-jqkp-ykp_gongan.html'),
    defaults: {
        back() {
            $("#gm_webplayer").hide();
            delete_ocx();
        ...
        onInit(event) {
            ...
            menuServer.menu.then(menu => {
                ...
                avalon.each(func_list, function (k, v) {
                    switch (v) {
                        case "AUDIO_FUNCTION_JDKP_JQKP_HCCL":
