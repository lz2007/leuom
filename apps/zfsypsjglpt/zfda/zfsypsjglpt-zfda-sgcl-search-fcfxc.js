 ...
 * @Last Modified time: 2019-10-22 16:27:08
 */
...
avalon.component('ms-sgcl-search-fcfxc', {
    ...
    defaults: {
                ...
                avalon.each(func_list, function (k, v) {
                    switch (v) {
                        case "AUDIO_FUNCTION_ZFDA_JTWF_FXCCL_SEARCH":
                            ...
                            break;
                        case "AUDIO_FUNCTION_ZFDA_JTWF_FXCCL_EXPORT":
        ...
        exportBtn() {
            ...
            let url = `//${window.location.host}${apiUrl}/gmvcs/audio/surveil/export?orgCode=${orgCode}&orgPath=${search_condition.orgPath}&includeChild=${search_condition.includeChild}&wfStartTime=${search_condition.wfStartTime}&wfEndTime=${search_condition.wfEndTime}&glmt=${search_condition.glmt}&userCode=${search_condition.userCode}&wfbh=${search_condition.wfbh}&jdsbh=${search_condition.jdsbh}&wfdz=${search_condition.wfdz}&hphm=${search_condition.hphm}`;
