...
export const name = "zfsypsjglpt-zfda-ajgl-ck-zzsm-gpbasm";
// require("/apps/zfsypsjglpt/zfsypsjglpt-zfda-ajgl-ck-zzsm-gpbasm.css");
function Tools() {};
...
let zfyps_vm = avalon.component(name, {
    template: __inline("./zfsypsjglpt-zfda-ajgl-ck-zzsm-gpbasm.html"),
    defaults: {
        input_blur(e) {
        ...
        propArr: ['zzdw','bz'],
        onInit() {
            let data = Gm_tool.getStorage('zjbasm');
            if (data) {
        ...
        onDispose(){
            ...
            Gm_tool.setStorage('zjbasm', data, 0.5, function () { 
                console.log(data) 
            }) ;
        }
    }
