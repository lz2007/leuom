...
import {
 ...
 require('./sszhxt-xxcj-cpcj.css');

export const name = 'sszhxt-xxcj-cpcj';
const jqdj = avalon.component(name, {
    template: __inline('./sszhxt-xxcj-cpcj.html'),
    defaults: {
        $form:createForm(),
        noData:false,
        sfzcjDetail:"",
...
let cpcjLookVideo = avalon.define({
    $id: 'cpcjLookVideo',
    show: false,
    cancelText:'关闭',
    title: '查看文件',
